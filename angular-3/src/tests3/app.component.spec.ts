...
describe('AppComponent', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            delete(entity: Construction): Observable<Construction> {
  ...
  it('onDelete method should exist', () => {
  ...
  it('data should exist in a table row', async () => {
    fixture.detectChanges();
    await fixture.whenStable();
  ...
  it('delete button should exist in a table row', async () => {
    fixture.detectChanges();
    await fixture.whenStable();
  ...
  it('onDelete method should be called when the user clicks the delete button', async () => {
    fixture.detectChanges();

    const delSpy = jest.spyOn<AppComponent, any>(app, 'onDelete');
